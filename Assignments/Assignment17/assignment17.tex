...
\section{Explanation}
Let $\{\vec{\alpha_1}, \vec{\alpha_2}, \cdots, \vec{\alpha_n}\}$ be an ordered basis of $\vec{F^n}$.\\
$\vec{A}$ is a matrix of T in the standard ordered basis. We know that the $i^{th}$ column of matrix $\vec{A}$ is given by $T\epsilon_i$, hence columns of $\vec{A}$ are the images of the standard basis elements of $\vec{F^n}$.\\

We know that $\{T\vec{\epsilon_1}, T\vec{\epsilon_2}, \cdots, T\vec{\epsilon_n}\}$ generate the range of T. Hence the columns of matrix $\vec{A}$ generate the range of T.\\
