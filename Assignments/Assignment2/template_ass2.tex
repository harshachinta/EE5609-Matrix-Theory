...
\end{align*}
Equation of the above line can be written as,
 \begin{align*}
& \myvec{x\\ y\\ z} = \myvec{7t+5\\ 5t-2\\ t} = \myvec{5\\ 2\\ 0} +t \myvec{7\\ -5\\ 1}
\end{align*}
From the above equation, the direction vector is given by $\vec{d_1}$ = \myvec{7\\ -5\\ 1}.\\
...
\end{align*}
From the above equation,  the direction vector is given by $\vec{d_2}$ = \myvec{1\\ 2\\ 3}.\\
Two lines are perpendicular to each other when the dot product of their direction vectors is 0.\\
\\
Dot product of direction vectors $\vec{d_1}$ and $\vec{d_2}$ is given by:\\
 \begin{align*}
...
As the dot product of direction vectors of the lines is 0 ($\vec{d_1^T}\vec{d_2}$ = 0), we can say that the lines are perpendicular to each other.
\\\end{document}