...
\begin{split}
\vec{m}_{DF}&=\vec{D}-\vec{F} \label{eq:res_1}\\
...
Consider equation \eqref{eq:res_1},
\begin{align}
...
\end{align}\\
From equation\eqref{eq:res_1}, $\vec{DF}\parallel\vec{BC}$ and from \eqref{eq:res_2}, the line-segment $\vec{DF}=\frac{1}{2}\vec{BC}$
